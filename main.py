...
(handles the snake and it's movement, array of cube class), ai class(enemy that moves towards the player)
and a cube class(draws cubes and remembers their directions).
"""""""""
...
def main():
    ...
    while True:
        ...
        s.move()
        a.ai_move(s.body[0].pos[0], s.body[0].pos[1])
